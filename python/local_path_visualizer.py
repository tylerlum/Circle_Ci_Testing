...
if __name__ == '__main__':
    ...
    # Ensure that this matches createLocalPathSS referenceLatlon for best results
    ...
    while not rospy.is_shutdown():
        ...
        # Creates a triangle with correct 'heading'
        positionPlot.set_marker((3, 0, state.headingDegrees - 90))
