...
# Constants
# Must keep well below 1.0 to ensure proper global wind direction
# calculation, even when the boat is turning
...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        if changeWindCounter >= changeWindMax:
            changeWindCounter = 0
            globalWindSpeedKmph = random.randint(
                MIN_GLOBAL_WIND_SPEED_KMPH, MAX_GLOBAL_WIND_SPEED_KMPH)
